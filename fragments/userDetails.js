...
export default function UserDialog({ visible, setVisible }) {
    ...
    const fetchTypes = async () => {
        await axios.get("http://192.168.1.61:3000/user/type").then(
            function (res) {
    ...
    const fetchRoles = async () => {
        await axios.get("http://192.168.1.61:3000/user/profile").then(
            function (res) {
                console.log(res.data);
                setRoles(res.data);
            })
    ...
    const saveUserToDB = async (email, firstname, lastname, role, type) => {
        ...
        //saving user
        await axios.post("http://192.168.1.61:3000/user", userData).then(
            function (res) {
                console.log(res);
        ...
        //saving resource
        await axios.post("http://192.168.1.61:3000/resource", resourceData).then(
            function (res) {
                console.log(res);
